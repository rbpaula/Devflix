  ...
  return (
    <div style={{ background: "#141414" }}>
      ...
      <BannerMain
        ...
        videoDescription={
          "O que � Front-end? Trabalhando na �rea os termos HTML, CSS e JavaScript fazem parte da rotina das desenvolvedoras e desenvolvedores. Mas o que eles fazem, afinal? Descubra com a Vanessa!"
        }
      />
